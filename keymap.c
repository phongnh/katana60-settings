...
[_QWERTY] = LAYOUT(
    ...
    SYM_GRV, KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,  KC_BSPC, SYM_BSP,          KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, SYM_GRV
),
...
[_DVORAK] = LAYOUT(
    ...
    KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_SLSH,          KC_EQL,  KC_F,    KC_G,    KC_C,    KC_R,    KC_L,     KC_BSLS,
